...
public sealed class Module : IModule
{
    private readonly List<PermissionItem> _permissions = new List<PermissionItem>
    {
        ...
        // New workflow permissions for Content
        new PermissionItem { Name = WorkflowPermissions.ContentSubmitForReview, Title = "Submit Content for Review", Category = "Content Workflow" },
        new PermissionItem { Name = WorkflowPermissions.ContentReview, Title = "Review Content", Category = "Content Workflow" },
        new PermissionItem { Name = WorkflowPermissions.ContentApprove, Title = "Approve Content", Category = "Content Workflow" },
        new PermissionItem { Name = WorkflowPermissions.ContentReject, Title = "Reject Content", Category = "Content Workflow" },
        ...
        // New workflow permissions for Pages
        new PermissionItem { Name = WorkflowPermissions.PagesSubmitForReview, Title = "Submit Pages for Review", Category = "Pages Workflow" },
        new PermissionItem { Name = WorkflowPermissions.PagesReview, Title = "Review Pages", Category = "Pages Workflow" },
        new PermissionItem { Name = WorkflowPermissions.PagesApprove, Title = "Approve Pages", Category = "Pages Workflow" },
        new PermissionItem { Name = WorkflowPermissions.PagesReject, Title = "Reject Pages", Category = "Pages Workflow" },
        ...
        // New workflow permissions for Posts
        new PermissionItem { Name = WorkflowPermissions.PostsSubmitForReview, Title = "Submit Posts for Review", Category = "Posts Workflow" },
        new PermissionItem { Name = WorkflowPermissions.PostsReview, Title = "Review Posts", Category = "Posts Workflow" },
        new PermissionItem { Name = WorkflowPermissions.PostsApprove, Title = "Approve Posts", Category = "Posts Workflow" },
        new PermissionItem { Name = WorkflowPermissions.PostsReject, Title = "Reject Posts", Category = "Posts Workflow" },
